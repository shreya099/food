...
{ $s=1;
	if($type=='de')
		$s=0;
	mysqli_query($conn,"UPDATE coupon_code SET status='$s' where id='$id'");
	//redirect('category.php');
}
}

$q="SELECT * from coupon_code order by id";
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div class="col-sm-6">
             ...
             <a href="manage_coupon.php"><button class="btn btn-primary">Add Coupon Code</button></a>
          </div><br>
      </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    <td><?php echo $i ?></td>
                    <td><?php echo $row['coupon_code'] ?>
                    </td>
                   
                   <td><?php echo $row['coupon_type'] ?>
                   <td><?php echo $row['coupon_value'] ?>
                   <td><?php echo $row['cart_min_value'] ?>
                   <td><?php echo $row['expired_on'] ?>
                   ...
                   $datestr=strtotime($row['added_on']);
                    echo date('d-m-Y',$datestr); ?>
                   	...
                   	<td>
                  <a href="manage_coupon.php?id=<?php echo $row['id']?>"><button class="btn btn-info">Edit</button></a> 
                  <?php
                  if($row['status']==1) {?>
